...
app.use(function)
```
![](/public/images/koa-middleware.jpg)
```js
const Koa = require('koa');
const app = new Koa();
...
```
## 4.1 上下文(Context)
Koa Context 将 node 的request 和 response 对象封装到单个对象中，为编写Web应用程序和API提供了许多有用的方法
...
- ctx.res // 原始的http响应对象
- ctx.app // 应用程序实例引用
- ctx.request 是Koa2中context经过封装的请求对象
...
# 15.generator
[koa-generator](https://github.com/i5ting/koa-generator)
```js
