                    ...
                    <div>
                        ...
                        </ul>
                        {
                            this.props.user&&<ul className="nav navbar-nav navbar-right">
                                <li><Link to="/users/signout">欢迎：{this.props.user.username}</Link></li>
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <div className="form-group">
                    ...
                    <textarea className="form-control" ref={input => this.content=input}></textarea>
                </div>
                <div className="form-group">
                    <input type="submit" className="btn btn-primary" />
                </div>
...
function * addArticle(action) {
    try {
        ...
        yield put({
            type: types.ADD_ARTICLE_ERROR, error
        });
    }
}
