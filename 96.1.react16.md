...
function createElement(type, config = {}, ...children) {
    ...
    props.children = children.map(item => typeof item === 'object' || typeof item === 'function' ? item : { $$typeof: TEXT, type: TEXT, content: item });
...
```
# 6.支持旧版生命周期
![](/public/images/lifecycle.png)
![](/public/images/lifecycle.jpg)
## 6.1 src\index.js
src\index.js
```js
import React from 'react';
